...
const formSchema = z.object({
    ...
    canadianWorkExperience: z.coerce.number().min(0).max(5),
    foreignWorkExperience: z.coerce.number().min(0).max(3),
    ...
    spouse_canadianWorkExperience: z.coerce.number().min(0).max(5).optional(),
