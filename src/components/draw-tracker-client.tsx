...
import { Award, Building, Calendar, ExternalLink, Filter, Info, Loader2, Search, Users, X, ArrowUp } from 'lucide-react';
      ...
      <div className={cn("grid grid-cols-1 items-start gap-6 lg:grid-cols-3", !selectedDraw && "lg:grid-cols-1")}>
          <div className={cn("lg:col-span-2 space-y-6", !selectedDraw && "lg:col-span-3")}>
              ...
              <div className="relative">
                <ScrollArea className="h-[calc(100vh-18rem)] pr-4" viewportRef={viewportRef} onScroll={handleScroll}>
                ...
                {showScrollTop && (
                    <Button 
                        ...
                        variant="outline"
                        size="icon"
                        className="absolute bottom-4 right-8 h-10 w-10 rounded-full ring-1 ring-white"
                    >
