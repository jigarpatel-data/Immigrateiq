...
const nocFinderChatbotFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    const prompt = `You are an expert Canadian immigration assistant specializing in the National Occupational Classification (NOC) system. Your task is to help users find the correct NOC code based on their job title or duties.
